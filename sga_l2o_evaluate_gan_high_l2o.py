        ...
        for wi in initial_w:
            ...
            while count < 100000:
                ...
                if count <= 1500:
                    ...
                    players_w[0] = players_w[0] - normalized[:players_w[0].shape[0]] * 1e-4
                    players_w[1] = players_w[1] - normalized[players_w[0].shape[0]:] * 1e-4
                else:
                ...
                if (count + 1) % 500 == 0:
                    ...
                    plt.savefig(f'eigen_{count}_l2o.png')
                    plt.close()
