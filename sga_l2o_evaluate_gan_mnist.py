...
def evaluate(net, game_list, formula, levels, args, slow=False):
    ...
    if True:
        ...
        loss = loss_gan_mnist()
        ws = []
        # epoch_w = [torch.randn(256 * 100 + 512 * 256 + 784 * 512 + 256 + 512 + 784).cuda(), torch.randn(512 * 784 + 256 * 512 + 1 * 256 + 512 + 256 + 1).cuda()]
        # gen_shapes = [(256, 100), (512, 256), (784, 512)]
        # dis_shapes = [(512, 784), (256, 512), (1, 256)]
        ...
        for wi in initial_w:
            ...
            while count < 100000:
                ...
                if (count + 1) % 500 == 0:
                    ...
                    save_image(denorm(z), f"{count + 1}.png", nrow=10)
    return counts
